...
<p align="center">
  ...
  <a >
   	...
   	<a href="https://github.com/hhprojects/dive-into-llms-en/stargazers">
       <img alt="stars" src="https://img.shields.io/github/stars/hhprojects/dive-into-llms-en" />
  	</a>
  	<a href="https://github.com/hhprojects/dive-into-llms-en/network/members">
       <img alt="FORK" src="https://img.shields.io/github/forks/hhprojects/dive-into-llms-en?color=FF8000" />
  	</a>
    <a href="https://github.com/hhprojects/dive-into-llms-en/issues">
      <img alt="Issues" src="https://img.shields.io/github/issues/hhprojects/dive-into-llms-en?color=0088ff"/>
    </a>
    <br />
</p>
...
| ---------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Fine-tuning and Deployment       | Fine-tuning and deployment guide for pre-trained models: Want to improve the performance of pre-trained models on specific tasks? Let's select appropriate pre-trained models, fine-tune them on specific tasks, and deploy the fine-tuned models into convenient demos! | [[Slides](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter1/dive-into-llm.pdf)] [[Tutorial](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter1/README.md)] [[Script](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter1/dive-tuning.ipynb)] |
| Prompt Learning and Chain of Thought | API calls and inference guide for large language models: "AI seeking encouragement online? Large language models' answers to some questions can be shocking, but it may just want a word of 'encouragement'" | [[Slides](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter2/dive-into-prompting.pdf)] [[Tutorial](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter2/README.md)] [[Script](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter2/dive-prompting.ipynb)] |
| Knowledge Editing         | Editing methods and tools for language models: Want to control language model memory of specific knowledge? Let's select appropriate editing methods, edit specific knowledge, and validate the edited models! | [[Slides](https://github.com/hhprojects/dive-into-llms-en/blob/main/documents/chapter3/dive_edit_0410.pdf)] [[Tutorial](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter3/README.md)]  [[Script](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter3/dive_edit.ipynb)] |
| Mathematical Reasoning         | How to enable large language models to learn mathematical reasoning? Let's quickly distill a mini R1! | [[Slides](https://github.com/hhprojects/dive-into-llms-en/blob/main/documents/chapter4/math.pdf)] [[Tutorial](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter4/README.md)]  [[Script](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter4/sft_math.ipynb)] |
| Model Watermarking         | Text watermarking for language models: Embed invisible watermarks in content generated by language models | [[Slides](https://github.com/hhprojects/dive-into-llms-en/blob/main/documents/chapter5/watermark.pdf)] [[Tutorial](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter5/README.md)]  [[Script](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter5/watermark.ipynb)] |
| Jailbreak Attacks         | To achieve better security, start by learning to attack. Let's understand how jailbreak attacks pry open large language models' mouths! | [[Slides](https://github.com/hhprojects/dive-into-llms-en/blob/main/documents/chapter6/dive-Jailbreak.pdf)] [[Tutorial](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter6/README.md)] [[Script](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter6/dive-jailbreak.ipynb)] |
| LLM Steganography       | "Invisible ink"! Want to have large language models smoothly answer questions while covertly carrying information that only "insiders" can recognize? LLM steganography tells you how! | [[Slides](https://github.com/hhprojects/dive-into-llms-en/blob/main/documents/chapter7/stega.pdf)] [[Tutorial](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter7/README.md)] [[Script](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter7/llm_stega.ipynb)] |
| Multimodal Models       | As multimodal large language models that can more fully simulate the real world, how can they achieve stronger multimodal understanding and generation capabilities? Can multimodal large language models help achieve AGI? | [[Slides](https://github.com/hhprojects/dive-into-llms-en/blob/main/documents/chapter8/mllms.pdf)]  [[Tutorial](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter8/README.md)] [[Script](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter8/mllms.ipynb)] |
| GUI Agent        | Want to have food handed to your mouth and free your hands? Then let's work together to have AI Agent order takeout, reply to messages, and compare shopping prices for you! | [[Slides](https://github.com/hhprojects/dive-into-llms-en/blob/main/documents/chapter9/GUIagent.pdf)]  [[Tutorial](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter9/README.md)] [[Script](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter9/GUIagent.ipynb)] |
| Agent Safety       | Large language model agents are on a journey toward future operating systems. However, can large language models be aware of risk threats in open agent scenarios? | [[Slides](https://github.com/hhprojects/dive-into-llms-en/blob/main/documents/chapter10/dive-into-safety.pdf)] [[Tutorial](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter10/README.md)] [[Script](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter10/agent.ipynb)] |
| RLHF Safety Alignment     | PPO-based RLHF experiment guide: This tutorial is "extremely dangerous". After reading, please check if your large language model is smirking. | [[Slides](https://github.com/hhprojects/dive-into-llms-en/blob/main/documents/chapter11/RLHF.pdf)] [[Tutorial](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter11/README.md)] [[Script](https://github.com/hhprojects/dive-into-llms-en/tree/main/documents/chapter11/RLHF.ipynb)] |
...
[![Star History Chart](https://api.star-history.com/svg?repos=hhprojects/dive-into-llms-en&type=Date)](https://star-history.com/#hhprojects/dive-into-llms-en&Date)
